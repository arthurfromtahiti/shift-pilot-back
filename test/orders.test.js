...
// SHIAAAAAAAAAAAAAAAAAAAAAAAA-461 \u2014 tri par total (total_asc / total_desc)
...
// SHIAAAAAAAAAAAAAAAAAAAAAAAA-461 \u2014 preuve que sortOrdersByTotal est num\u00E9rique
test("sortOrdersByTotal('asc') trie par total croissant", () => {
...
test("sortOrdersByTotal('desc') trie par total d\u00E9croissant", () => {
  const { sortOrdersByTotal } = require("../src/routes/orders");
